...
// ESP32-C6 PORT: stored as int16_t instead of int32_t. Values are
// clamped to [-1, viewwidth+1] (viewwidth=320 in our build), well
// within int16_t range. Saves 8 KiB of .bss.
