...
// ESP32-C6 PORT: vanilla is 128 (~20 KB of ticdata for net latency
// buffering). We're single-player, no networking — drop to 4 to save
// ~19 KB of .bss. Tic-resync code uses a few entries for input-frame
// pacing; 4 is the smallest value that keeps that loop sane.
#define BACKUPTICS 4
