...
{
    // ESP32-C6 PORT: no filesystem (CONFIG_VFS_SUPPORT_DIR=n), no
    // savegames. mkdir is unlinked from libc — stub this out so DOOM's
    // savegame-init path is a no-op rather than a link error.
    (void)path;
}
